...
public class UploadObject {
    ...
    public static void upload(String bucketNome, String fileObjKeyName, String fileName ) throws IOException {
        ...
        try {
            ...
            PutObjectRequest request = new PutObjectRequest(bucketNome, fileObjKeyName, new File(fileName));
